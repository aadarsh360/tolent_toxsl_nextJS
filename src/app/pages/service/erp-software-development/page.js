        ...
        <>
            ...
            <div className='mt-5 py-5'>
                <div className='container py-5'>
                    <span className='bg-danger px-3 py-2 my-5 text-white'>Inventory Management</span>

                    <h1 className='py-2'>Inventory Management</h1>
                    ...
                    <div className=" my-5">
                        ...
                        <h4 className="text-center py-2 " >Explore Our Management</h4>
